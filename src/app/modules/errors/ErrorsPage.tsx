...
const ErrorsPage: React.FC<React.PropsWithChildren<unknown>> = () => {
        ...
        <div className='d-flex flex-column flex-column-fluid text-center p-10 py-lg-20'>
          ...
          <div className='pt-lg-10 mb-10'>
            ...
            <Routes>
              ...
              <Route path='/error' element={<Navigate to='/error/404'/>}></Route>
              <Route element={<Navigate to='/error/404'/>}></Route>
            </Routes>
